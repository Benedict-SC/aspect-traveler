...
encounters[id] = {
    ...
    frames:[
        ...
        },
        {
            id:"COLD",
            image:"normal",
            text:"\"I'm just kind of worried it could be dangerous. It's more or less three suns at once. What if it makes all the snow on the mountain melt? We'd get washed away by all the meltwater!\"\n\nShe shakes her head. \"I'm being silly, aren't I.\"\n\nShe looks happy you asked, though. (+1 @)",
            options:[
                {text: "Continue",effect:"end"}
            ]
        }
