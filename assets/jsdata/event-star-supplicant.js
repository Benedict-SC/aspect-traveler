...
encounters[id] = {
    ...
    frames:[
        ...
        },
        {
            ...
            options:[
                {text: "Give the blessing freely.",effect:"delta",light:-2,heat:2,frameIdx:2},
                {text: "Give the blessing in exchange for something.",effect:"none",frameIdx:3},
                {text: "Don't give a blessing.",effect:"delta",cold:1,heat:-1,frameId:"refuse"}
            ]
        },
        {
            image:"normal",
            text:"The star touches her hand to the child, and the pallor in their skin leaves the child in an instant. She stumbles, afterwards, but the supplicant seems endlessly grateful, and that makes it worth it for both you and her. (-2 {, +2 $.)",
            options:[
        ...
        },
        {
            id:"supplies",
            image:"normal",
            text:"You could always use more supplies. The supplicant doesn't have much to trade, but they agree to part with some of their food for your star's magic. (+2 }.)\n\nAfter the deal is struck, the star touches her hand to the child, and the pallor in their skin leaves the child in an instant. She stumbles, afterwards, -2 {, but the two of you got what you needed out of the deal. Time to move on.",
            options:[
                {text: "Continue",effect:"end"}
            ]
        },
        {
            id:"vitality",
            image:"normal",
            text:"A magical gift has a magical price. Here's your offer: she can cure the child in exchange for a portion of vitality.\n\nThe supplicant hesitates, but ultimately decides the price is worth it. The star touches one hand to the supplicant, and the other to you, and you feel something transferring from them through her to you. (+2 @.)\n\nAfter the deal is struck, the star touches her hand to the child, and the pallor in their skin leaves the child in an instant. She stumbles, afterwards, -2 {, but the two of you got what you needed out of the deal. Time to move on.",
            options:[
                {text: "Continue",effect:"end"}
            ]
        },
