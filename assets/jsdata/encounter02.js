...
encounters[id] = {
    ...
    frames:[
        ...
        {
            image:"normal",
            text:"She draws some of your [embed heat symbol somehow], and begins to shine like the sun. You don't feel as warm anymore, but the ice is melting before you, running down the mountainside in steaming rivulets.\n\nStanding where the glacier once was are a group of travelers, shivering in the chilly mountain air, gasping for breath.\n\n\"See? Just like that!\"\n\n Well! She is a doer of miracles. How about that.",
            options:[
                {text: "Continue",effect:"end"}
            ]
        },
